...
\toprule
\addlinespace[0.1cm]
\textsf{\emph{Phenology}} \\
$ \mr{Seed}(\ar{gntp}{a}, \ar{dev}{d}, \ar{r}{r}) \xrightarrow{1.0} $ \\
\addlinespace[-0.27cm]
$\mr{Seed}(\ar{dev}{d + htu(temp, moist, f(r,temp,moist), a.\psi_i)}, \mr{r}{f(r, temp, moist)})$ \\

$\mr{Seed}(\ar{gntp}{a},\ar{dev}{d},\ar{r}{r} ) \xrightarrow{1.0} $
$\mr{Plant}(\ar{gntp}{a}), \mr{Root}(\ldots),\mr{Leaf}( \ldots ), \mr{Leaf}(\ldots) \, \, \lbrack d > D_{g}\rbrack$ \\

$\mr{Plant}(\ar{gntp}{a},\ar{dev}{d}, \ar{wc}{w}) \xrightarrow{1.0} \mr{Plant}(\ar{dev}{d + mptu( temp, dl, a.f_{i}, w )},\ar{wc}{f(w)})$ \\

$\mr{Plant}(\ar{gntp}{a}, \ar{dev}{d}, \ar{wc}{w}) \xrightarrow{1.0} \mr{\ FPlant}(\ar{gntp}{a}) \, \, \lbrack d > D_{f} \rbrack$ \\

$\mr{FPlant}( \ar{dev}{d} ) \xrightarrow{1.0} \mr{FPlant}(\ar{dev}{d + tu(temp)})$ \\

$\mr{FPlant}( \mr{attr} = a,\mr{\ dev} = d ) \xrightarrow{1.0} \mr{Seed}( \mr{attr} = a,\ \mr{dev} = 0,\ r = 0 )\ \ \lbrack d > D_{s}\rbrack$ \\
\addlinespace[0.2cm]
\textsf{\emph{Metabolism}} \\
\textsf{growth (per organ type)} \\
\addlinespace[-0.1cm]
$\mathrm{Leaf}(\ar{m}{m},\ar{i}{i}), \mathrm{Cell}(\ar{c}{c}) \xrightarrow{d_l(i, t)}
\mathrm{Leaf}(\ar{m}{m+g_l(m)}), \mathrm{Cell}(\ar{c}{c-g_l(m)}) [c-g_l(m) > c_b]$ \\

$\mathrm{Root}(\ar{m}{m}), \mathrm{Cell}(\ar{c}{c}) \xrightarrow{d_r(t)}
\mathrm{Root}(\ar{m}{m+g_r(m)}), \mathrm{Cell}(\ar{c}{c-g_r(m)}) [c-g_r(m) > c_b]$ \\

$\mathrm{LLeaf}(\ar{m}{m}), \mathrm{Cell}(\ar{c}{c}) \xrightarrow{d_{ll}(t)}
\mathrm{LLeaf}(\ar{m}{m+g_{ll}(m)}), \mathrm{Cell}(\ar{c}{c-g_{ll}(m)}) [c-g_{ll}(m) > c_b]$ \\

$\mathrm{INode}(\ar{m}{m}), \mathrm{Cell}(\ar{c}{c}) \xrightarrow{d_{i}(t)}
\mathrm{INode}(\ar{m}{m+g_{i}(m)}), \mathrm{Cell}(\ar{c}{c-g_{i}(m)}) [c-g_{i}(m) > c_b]$ \\
...
Adding genetic variation between generations will in future model Arabidopsis
