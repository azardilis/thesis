In the previous chapter I gave some example illustrating how Chromar works. In
...
(\sct{extSyntax}).  In contrast, in a \emph{concrete} realisation of
the language a particular choice is made.  For example, the Haskell embedding of
extended Chromar (\sct{impl}) provides such a concrete realisation,
...
were introduced informally in \sct{overview}. Observables and
