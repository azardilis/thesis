...
\begin{figure}[tb]
  ...
  \caption{Plant biology research is usually concerned with the top part of the
    ...
    hypotheses about the 'why' \citep[adapte
...
through the control of developmetal events. The assumption is then that these
...
reference to the aims and dicussion above, specifically my contributions are:
