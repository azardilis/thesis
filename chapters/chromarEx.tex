...
models in Chapter~\ref{chp:fms}. Again computationally with, for example, large
population simulations at the individual level might not be preferred, but a
description of the rules in Chromar could still be valuable as documentation of
our understanding. Other quantities (\ie not discrete objects -- agents) can be
mixed as well by encoding as agent attributes or fluents.
...
%+ econonomics and social sciences
