...
Beyond biology, again, we see formal representations with similar
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/systemsBio/flow.eps}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/systemsBio/haskChrom.eps}
