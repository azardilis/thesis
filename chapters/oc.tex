...
The FM takes environmental inputs (CO2 level, temperature, light intensity, and
...
\begin{figure}[tb]
\centering
\includegraphics[width=\textwidth]{figures/fmFig/agentFlows.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\textwidth]{figures/directResFig/compsAll}
\caption{
...
\begin{figure}[tb]
\centering
\includegraphics[width=\textwidth]{figures/exp/expRes.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\textwidth]{figures/indirectPFig/indirectOC.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\textwidth]{figures/indirectResFig/indRes}
\caption{
