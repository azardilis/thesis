...
well. Modelica is an object-oriented language combining traditional dynamics
representation with structure \citep{fritzson_modelicaunified_1998}. Later
extensions also added dynamic structure \citep{nytsch-geusen_mosilab:_2005}.
\todo{others?}

We next focus in more detail on Simile, which has been used before in Biology.
