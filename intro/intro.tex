...
plant domain starting from plant science and then going to the ecology and crop
areas. We will then overview the language question in multi-scale models that
...
Plants in general and their interaction with the environment all the way to the
ecosystem and evolution. How and why questions?
...
data collection on population genetics Arabidopsis since we have genome etc.
distribution of species

making sense of data?
Phenology models, donohue, wilczek-> others?

Important issue in plants is control of life history (phenology)
This gives ground for some modelling work done
This is adaptation indirectly to the environment since life history determines
the environment at different developmental stages

although there is more work on adaptation to other things directlye like
temperature
See Caroline Dean and Juliette de Meaux

The importance and simplicity of the phenology story gives rise to the only (is
it the only?) modelling work in the field

We ask the why questions but wheres the how? Or we have the some part of the how
and make hypotheses about the why..

More systems view come from modelling and suggested by Millar and Donohue 
