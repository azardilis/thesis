...
The Framework Model is a whole-plant model that represents vegetative growth of
Arabidopis Thaliana incorporating processes ranging multiple scales of
organisation. At the genetic level the well-studied circadian clock, metabolism
...
% for engineering, more application oriented
% interventions for increasing performance etc.
% different uses
...
% sometimes events are investigated together to see co-evolution
