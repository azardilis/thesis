...
molecular mechanism, the circadian clock \citet[FMv1]{chew_multiscale_2014}. On
...
\caption{A generic plant model with the standard flow-based view of a plant
  \citep{france_mathematical_1984}. The plant is represented by several state
  variable representing the levels of various nutrients in different parts of
  ...
  of the plant and espcially the fruits or seeds, which are important traits for
  agriculture.}
  \label{fig:plantFlow}
\end{figure}
...
\item An extension of the Framework Model (FM; \ssec{fm}) to the full-lifecycle
  including reproduction and see dormancy along with modifcations that allow its
  operation realistic weather ranges. This is combined with full-lifecycle
...
\item An application of the Framework Model with an engineering perspective,
  like the crop models. Instead of taking the traditional approach to engineer
