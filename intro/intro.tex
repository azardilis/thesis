...
% Standard molecular models, focus on photosynthesis etc. envrinomental effects
% important
% % rasse tocquin and other crop style
% I guess we should introduce structural models, they're interesting also given
% the previous discussion on organisation
% Then two scale, development + something
% - auxin diffusion and movement
% - functional structural greenlab
...
% when considering plant could introduce the crop style model of carbon movemnt
% and reservoirs, important for later
%actually the more comprehensive plant organism models came from here!
