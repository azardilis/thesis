...
table then it might be hard to find a mathematical description that fits the the
...
dynamical systems theory. Rules on discrte objects, operating on the objects or
...
not integrated as it is the case in CPNs and CSMMR, for example.

%semantics?
There is an obvious interpretation of the first-level continuous variables as a
systems of differential equations but there is no obvious intepretation as a
...
\begin{center}
  \includegraphics[scale=0.5]{figures/simileGrowth.eps}
\end{center}
...
\begin{center}
  \includegraphics[scale=0.5]{figures/simileRoot.eps}
\end{center}
...
Finally, again, like CPNs, the graphical notation of Simile becomes, in our experience,
